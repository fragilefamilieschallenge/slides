...
\date{July 24, 2018\\AI4ALL\\Princeton University \\\vfill
\begin{flushleft}{\scriptsize
Supported by the Russell Sage Foundation. Board of Advisors: Jeanne Brooks-Gunn, Kathryn Edin, Barbara Engelhardt, Irwin Garfinkel, Moritz Hardt, Dean Knox, Nicholas Lemann, Karen Levy, Sara McLanahan, Arvind Narayanan, Timothy Nelson, Matthew Salganik, \& Duncan Watts.  Source: \textcolor{blue}{\textcolor{blue}{\href{http://github.com/fragilefamilieschallenge/slides}{www.github.com/fragilefamilieschallenge/slides}}} \includegraphics[width=0.05\textwidth]{figures/cc.png}}
\end{flushleft}
}
...
\end{itemize}
\pause to develop insights that can improve the lives of disadvantaged children in the US.  
...
\begin{center}
\includegraphics[width=0.95\textwidth]<1>{figures/Rsquared_all_bestindividual}
\includegraphics[width=0.95\textwidth]<2>{figures/Rsquared_all_01_bestindividual}
\end{center}

\vfill
$R^2 = 1 - \frac{\sum_{i \in \textrm{holdout}} (\hat{y}_i - y_i)^2}{\sum_{i \in \textrm{holdout}} (\bar{y}_{train} - y_i)^2}$\\
Talk summarizing the results: \textcolor{blue}{\url{https://youtu.be/HrYPtdXeSaM}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
...
Working with this data may be frustrating . . . 
